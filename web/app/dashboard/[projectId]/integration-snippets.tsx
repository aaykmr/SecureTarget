        ...
        <ol className={styles.steps}>
          ...
          <Step n={4} title="Wire campaign traffic (optional)">
            <p>
              ...
              <Link href={`/dashboard/${projectId}/links`} className={styles.inlineLink}>
                Links
              </Link>
          ...
          <Step n={5} title="Verify events">
            <p>
              Open{" "}
              <Link href={`/dashboard/${projectId}/events`} className={styles.inlineLink}>
                Events
              </Link>{" "}
  ...
  value: 29.99
          ...
          <Step n={7} title="Verify install attribution">
            <p>
              ...
              <Link href={`/dashboard/${projectId}/attribution`} className={styles.inlineLink}>
                Attribution
              </Link>{" "}
              after clicking a{" "}
              <Link href={`/dashboard/${projectId}/links`} className={styles.inlineLink}>
